...
# options passed:  -D_GNU_SOURCE disassemblyLab.cpp -mtune=generic
# -march=x86-64 -auxbase-strip disassemblyLabO1.s -g -O2 -fverbose-asm
...
main:
.LFB13:
	.file 1 "disassemblyLab.cpp"
	.loc 1 8 12 view -0
	.cfi_startproc
	.loc 1 9 9 view .LVU1
# disassemblyLab.cpp:8: int main() {
	.loc 1 8 12 is_stmt 0 view .LVU2
	subq	$8, %rsp	#,
	.cfi_def_cfa_offset 16
# disassemblyLab.cpp:9:         printf("%d", add(3,1));
	...
	call	printf	#
.LVL0:
	.loc 1 10 9 is_stmt 1 view .LVU4
# disassemblyLab.cpp:11: }
...
.LASF41:
	.string	"_shortbuf"
.LASF89:
	.string	"disassemblyLab.cpp"
.LASF29:
	.string	"_IO_buf_base"
.LASF90:
	.string	"/home/u1431008"
.LASF79:
	.string	"remove"
.LASF16:
	.string	"__mbstate_t"
